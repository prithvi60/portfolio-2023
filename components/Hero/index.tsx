  ...
  return (
    <>
      <Suspense fallback={<Loader />}>
        <section
          id="home"
          className=" relative z-10 overflow-hidden pt-[120px] pb-16 h-screen md:pt-[150px] md:pb-[120px] xl:pt-[180px] xl:pb-[160px] 2xl:pt-[210px] 2xl:pb-[200px]"
        >
          ...
          {/* <div className="bottom-0 pt-8 md:absolute md:w-screen">
            {/* // <Brands /> */}
            {/* <h1>Captivate. Engage. Inspire.</h1> */}
          {/* </div> */} 
          {/* <div className="flex justify-center items-center md:pt-16 md:absolute md:w-screen">
            <h1>Captivate. Engage. Inspire.</h1>
          </div> */}
        </section>
      </Suspense>
